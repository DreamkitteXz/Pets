...
class _VacinaPageState extends State<VacinaPage> {
  ...
  Widget build(BuildContext context) {
    // Debug messages to see the validation info
    print(
        "Vet Validation Info: ${widget.vacina.validationDetails?['vetValidation']}");
    print(
        "Tutor Validation Info: ${widget.vacina.validationDetails?['tutorValidation']}");
    // Debug messages to see all the data being fetched from Firebase
    print("Vaccine Data: ${widget.vacina.toJson()}");
